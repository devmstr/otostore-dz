...
import { z } from 'zod'
import { CATEGORIES, PRICE_RANGES } from '@/lib/constants/product'
...
const getProductsSchema = z.object({
  ...
  price: z.enum(PRICE_RANGES).optional()
})
...
export async function createProductAction(
  ...
  const product = await container.productService.createProduct({
    ...validated,
    id: BigInt(13),
    price: validated.price ?? 0.1,
    name: 'Unknown'
  })
