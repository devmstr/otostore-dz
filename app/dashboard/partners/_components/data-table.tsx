...
import { DataTablePagination } from './customers/data-table-pagination'
import { DataTableToolbar } from './customers/data-table-toolbar'
import { LoaderCircle } from 'lucide-react'
import { useTableUrlParamsState } from '@/hooks/use-table-url-params-state'
import { useQuery } from '@tanstack/react-query'
import { getAllCustomersQueryOption } from '../_queries/customers/queries'
...
export function DataTable<TData, TValue>({
  ...
  const {
    ...
    filterableColumns: [
      ...
      { id: 'customerTiers', type: 'multi-select', paramName: 'type' },
  ...
  const { data, isLoading, isError, error } = useQuery(
    getAllCustomersQueryOption(getSearchParams())
  )
