import type { SidebarData } from "./types" // Assuming SidebarData is declared in a types file
...
export const sidebarData: SidebarData = {
  user: {
    ...
    avatar: "https://lh3.googleusercontent.com/a/ACg8ocIcoMnbpu9TLBQc4uWFYTRUfgPrSaXQwHkvjVgRFUJkx9KSMMQS=s83-c-mo",
  },
  teams: [
  ...
  navGroups: [
    {
      ...
      items: [
        ...
        { title: "POS", url: "/dashboard/pos", icon: "ShoppingCart" },
