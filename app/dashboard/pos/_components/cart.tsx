  ...
  return (
    <Card className="flex flex-col p-6">
      ...
      <div className="flex-1 space-y-3 overflow-y-auto">
        {items.length === 0 && <p className="text-center text-sm text-muted-foreground">Cart is empty</p>}
        ...
        {items.map((item) => (
          <div key={item.id} className="flex items-center gap-2 rounded-lg border p-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => onRemove(item.id)}>
