...
import { getCustomerAction } from "../_actions/customers"
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-bold">${Number(customer.totalSpent).toFixed(2)}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <Badge className="bg-purple-500/10 text-purple-500">{customer.loyaltyPoints}</Badge>
            </div>
          </CardContent>
        </Card>
      </div>
