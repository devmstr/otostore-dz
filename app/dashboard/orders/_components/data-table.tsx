...
interface DataTableProps<TData, TValue> {
  columns: ColumnDef<OrderDto, any>[]
}
  ...
  const { columnFilters, getSearchParams, pagination, setColumnFilters, setPagination, setSorting, sorting } =
    useTableUrlParamsState({
      ...
      filterableColumns: [
        ...
        { id: "paymentStatus", type: "multi-select" },
        { id: "orderNumber", type: "search", paramName: "search" },
      ],
    })

  // Query data from server
  const { data, isLoading, isError, error } = useQuery(getAllOrdersQueryOption(getSearchParams()))
