...
import { getAllInventoryQueryOption } from "../_queries/queries"
  ...
  const { columnFilters, getSearchParams, pagination, setColumnFilters, setPagination, setSorting, sorting } =
    useTableUrlParamsState({
      ...
      filterableColumns: [
        ...
        { id: "stockStatus", type: "multi-select" },
        { id: "name", type: "search", paramName: "search" },
      ],
    })

  // Query data from server
  const { data, isLoading, isError, error } = useQuery(getAllInventoryQueryOption(getSearchParams()))
