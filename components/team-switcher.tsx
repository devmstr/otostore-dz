...
export function TeamSwitcher({ teams }: { teams: SidebarData['teams'] }) {
  ...
  // 👇 Explicitly cast to LucideIcon so TS knows it's a React component
  const ActiveIcon = LucideIcons[activeTeam.logo] as LucideIcon
        ...
        <DropdownMenu>
          ...
          >
            ...
            {teams.map((team, index) => {
              const Logo = LucideIcons[team.logo] as LucideIcon
              return (
                <DropdownMenuItem
                  key={team.name}
