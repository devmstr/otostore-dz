...
import { getAllSuppliersQueryOption } from "../_queries/queries"
import type { SupplierDto } from "@/domain/dto/supplier.dto"

interface DataTableProps<TData, TValue> {
  columns: ColumnDef<SupplierDto, any>[]
}
...
export function DataTable<TData, TValue>({ columns }: DataTableProps<TData, TValue>) {
  ...
  const { data, isLoading, isError, error } = useQuery(getAllSuppliersQueryOption(getSearchParams()))
